document.addEventListener('DOMContentLoaded', function () {
  ...
  const calendarId = 'f22ae9715ec12be9267ec6295506bb09c99ea292a4e863cd70dfff1cccf4586a@group.calendar.google.com';

  const calendarEl = document.getElementById('schedule-p4');
  const calendar = new FullCalendar.Calendar(calendarEl, {
    initialView: 'dayGridFourWeek',
    timeZone: 'America/New_York',
    initialDate: '2024-10-05',
    firstDay: 1,
    views: {
      dayGridFourWeek: {
        type: 'dayGrid',
